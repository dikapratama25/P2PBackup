                ...
                <table style="margin-left: 50px;">
                    <tr>
                        ...
                        <td rowspan="2" style="font-family: Arial, Helvetica, sans-serif; color: #333;">
                            Status
                            <br/>
                            <span style="font-weight: 600; color: #2a596d;margin-top: 10px;">Rejected</span>
                        </td>
                    </tr>
                </table>
                <table style="margin-left: 50px;">
                    <tr>
                        <td style="padding-top: 10px;">
                            <img src='https://i.postimg.cc/kXFzHMrC/PO-Rejection-Notification.png' alt='Frame-1'/>
                        </td>
                    </tr>
                </table>
                <table style="margin-left: 50px;">
                    ...
                    <tr>
                        <td style="color: #333;padding-top: 20px; font-family: Arial, Helvetica, sans-serif; padding-bottom: 20px;">PO with the following detail has been rejected by your Approving Officer, <br/> please review the following detail :</td>
                    </tr>
                </table>
                <table style="margin-left: 50px;">
					<tr>
						<td style="color: #333;width: 100px; font-weight: 600;font-family: Arial, Helvetica, sans-serif;">VendorName</td>
					...
					<tr>
						<td style="color: #333;width: 100px; font-weight: 600;font-family: Arial, Helvetica, sans-serif;">PO Date</td>
						<td style="color: #333;width: 20px;font-family: Arial, Helvetica, sans-serif;">:</td>
						<td style="color: #333;font-family: Arial, Helvetica, sans-serif;">[PODate]</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="color: #333;width: 100px; font-weight: 600;font-family: Arial, Helvetica, sans-serif;">Approval Remark</td>
						<td style="color: #333;width: 20px;font-family: Arial, Helvetica, sans-serif;">:</td>
						<td style="color: #333;font-family: Arial, Helvetica, sans-serif;">[ApprovalRemark]</td>
					</tr>
                </table>
