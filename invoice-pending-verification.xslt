    ...
    <table style="background-color: #ffff; margin: 0 auto; width: 600px;">
        <tr>
            <td>
                ...
                <table style="margin-left: 50px;">
                    <tr>
                        <td style="color: #333;font-family: Arial, Helvetica, sans-serif; font-weight: 600; font-size: 20px;padding-top: 20px;">[Approver],</td>
                    </tr>
                    <tr>
                        <td style="color: #333;padding-top: 20px; font-family: Arial, Helvetica, sans-serif; padding-bottom: 20px;">You have received an invoice created by vendor Anjuria Sdn Bhd with the following detail, please review the following detail :</td>
                    </tr>
                </table>
                <table style="margin-left: 50px;">
                    <tr>
