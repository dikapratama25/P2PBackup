            ...
            <td>
                ...
                <table style="margin-left: 50px;">
                    <tr>
                        <td style="padding-top: 10px;">
                            <img src='https://i.postimg.cc/fydGgww4/GRN-Acknowledgement.png' alt='Frame-1'/>
                        </td>
                    </tr>
                </table>
                <table style="margin-left: 50px;">
                    <tr>
                        <td style="color: #333;font-family: Arial, Helvetica, sans-serif; font-weight: 600; font-size: 20px;padding-top: 20px;">Dear [VendorName] <br/> [Role],</td>
                    </tr>
                    <tr>
                        <td style="color: #333;padding-top: 20px; font-family: Arial, Helvetica, sans-serif;">You have received a new GRN from G. [BuyerName]</td>
                    </tr>
                    <tr>
                        <td style="color: #333; font-family: Arial, Helvetica, sans-serif;">with the following detail, please review the following detail :</td>
                    </tr>
                </table>
                <table style="margin-left: 50px;">
                    <tr>
                ...
                <table style="background-color: #F6F8F3;margin-top: 20px;">
                    <tr>
                        ...
                        <td style="color: #333;width: 350px;color: #179740;font-family: Arial, Helvetica, sans-serif;">Please login to testhub@me.com <br/> to acknowledge it</td>
