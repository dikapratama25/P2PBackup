    ...
    <table style="background-color: #ffff; margin: 0 auto; width: 600px;">
        <tr>
            <td>
                ...
                <table style="margin-left: 50px;">
                    <tr>
                        <td style="padding-top: 10px;">
                            <img src='https://i.postimg.cc/CLr5HtrL/Frame-1.png' alt='Accepted'/>
                        </td>
                    </tr>
                </table>
                <table style="margin-left: 50px;">
                    ...
                    <tr>
                        <td style="color: #333;padding-top: 20px; font-family: Arial, Helvetica, sans-serif;">ADO with the following detail has been received, please review</td>
                    </tr>
                    <tr>
                        <td style="color: #333;font-family: Arial, Helvetica, sans-serif;padding-bottom: 20px;">the following detail :</td>
                    </tr>
                </table>
                <table style="margin-left: 50px;">
                    <tr>
                        ...
                        <td style="color: #333;font-family: Arial, Helvetica, sans-serif;padding-bottom: 10px;">[DO_NO]</td>
                    </tr>
                    <tr>
                        ...
                        <td style="color: #333;font-family: Arial, Helvetica, sans-serif;">[PO_NO]</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="color: #333;width: 20px;font-family: Arial, Helvetica, sans-serif;padding-bottom: 10px;">:</td>
                        <td style="color: #333;font-weight: 600;font-family: Arial, Helvetica, sans-serif;padding-bottom: 10px;">[CustomerName]</td>
                    </tr>
                    <tr>
                        <td style="color: #333;width: 100px;font-family: Arial, Helvetica, sans-serif;">Company</td>
                        <td style="color: #333;width: 20px;font-family: Arial, Helvetica, sans-serif;">:</td>
                        <td style="color: #333;font-weight: 600;font-family: Arial, Helvetica, sans-serif;">[CompanyDesc]</td>
                    </tr>
                    <tr>
                ...
                <table style="background-color: #F6F8F3;">
                    <tr>
