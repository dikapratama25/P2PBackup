                ...
                <table style="margin-left: 50px;">
                    <tr>
                        <td style="padding-top: 10px;">
                            <img src='https://i.postimg.cc/xC89mmDT/PO-Pending-Approval-Notification.png' alt='Frame-1'/>
                        </td>
                    </tr>
                </table>
                <table style="margin-left: 50px;">
                    ...
                    <tr>
                        <td style="color: #333;padding-top: 20px; font-family: Arial, Helvetica, sans-serif; padding-bottom: 20px;">Outstanding PO with the following detail waiting for approval, <br/> please review the following detail :</td>
                    </tr>
                </table>
                <table style="margin-left: 50px;">
					<tr>
