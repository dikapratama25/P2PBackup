                ...
                <table style="margin-left: 50px;">
                    <tr>
                        <td style="padding-top: 10px;">
                            <img src='https://i.postimg.cc/50bCWnCK/PO-Approved-Notification-To-Vendor.png' alt='Frame-1'/>
                        </td>
                    </tr>
                </table>
                <table style="margin-left: 50px;">
                    ...
                    <tr>
                        <td style="color: #333;padding-top: 20px; font-family: Arial, Helvetica, sans-serif; padding-bottom: 20px;">A new PO with the following detail has been received from <br/> AA Technic (M) Sdn Bhd Buyer, please review the following detail :</td>
                    </tr>
                </table>
                <table style="margin-left: 50px;">
                    <tr>
