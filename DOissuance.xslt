            ...
            <td>
                ...
                <table style="margin-left: 50px;">
                    <tr>
                        <td style="padding-top: 10px;">
                            <img src='https://i.postimg.cc/C5bpvj0H/DO-Issuance-Notification.png' alt='Frame-1'/>
                        </td>
                    </tr>
                </table>
                <table style="margin-left: 50px;">
                    ...
                    <tr>
                        <td style="color: #333;padding-top: 20px; font-family: Arial, Helvetica, sans-serif;">DO with the following detail has been created, please review</td>
                    </tr>
                    <tr>
                ...
                <table style="margin-left: 50px;">
                    ...
                    <tr>
                        ...
                        <td style="color: #333;width: 20px;font-family: Arial, Helvetica, sans-serif;padding-bottom: 10px;">:</td>
                        <td style="color: #333;font-weight: 600;font-family: Arial, Helvetica, sans-serif;padding-bottom: 10px;">[Buyer]</td>
                    </tr>
                    <tr>
                        <td style="color: #333;width: 100px;font-family: Arial, Helvetica, sans-serif;">Company</td>
                        <td style="color: #333;width: 20px;font-family: Arial, Helvetica, sans-serif;">:</td>
                        <td style="color: #333;font-weight: 600;font-family: Arial, Helvetica, sans-serif;">[Company]</td>
                    </tr>
                </table>
